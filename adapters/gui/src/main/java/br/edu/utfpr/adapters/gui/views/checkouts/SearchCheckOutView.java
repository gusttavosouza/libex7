...
public class SearchCheckOutView extends Stage{
	...
	private void init() {
		...
		TableColumn<CheckOut, String> columCheckOutDate = new TableColumn<>("Data Empr�stimo");
		TableColumn<CheckOut, String> columUser = new TableColumn<>("Usu�rio");
		TableColumn<CheckOut, String> columExpectedCheckInDate = new TableColumn<>("Data Prevista Devolu��o");
